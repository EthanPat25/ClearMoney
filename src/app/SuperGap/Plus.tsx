...
const Plus = ({className}:any) => {
  return (
    <div className = {className}>
        <svg  onClick = {() => (console.log())} className = {"mx-auto cursor-pointer"}  version="1.1" id="fi_149705" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 42 42" enableBackground = "new 0 0 42 42" xmlSpace="preserve">
