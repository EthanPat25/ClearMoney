...
const page = () => {
  return (
    ...
    <div className="flex flex-col items-center p-14 w-full">
                 ...
                 <div className='flex w-full justify-center items-center mt-[80rem]'>
                        </div>
                        ...
                        <h1 className=' text-4xl font-bold text-center mt-5'>Different Tax Rules Apply To <span className='text-[RGB(0,133,135)]'>Super.</span></h1>
                        <h1 className='text-[RGB(82,95,127)] text-2xl mt-4 text-center'> Understanding these rules can help you make smarter decisions</h1>
                        </div>
                        ...
                        <h1 className=' text-4xl font-bold mt-16 text-center'>Super Contributions are classified as either: </h1>
       ...
       <div className='flex justify-evenly mt-10 mb-96'>
        ...
        <p className="text-sm text-[RGB(251,99,64)] font-semibold">Understand</p>
            ...
            <h2 className="font-bold xs:text-[1rem] sm:text-[1.5rem] md:text-[2.5rem] text-white">Concessional</h2>
        
            <ul>
                <li className='text-[RGB(229,229,229)] text-[1.2rem]'>1. Contributions from income you haven’t paid tax on yet</li>
                <li className='text-[RGB(229,229,229)] text-[1.2rem]'>2. Taxed at 15% when deposited into super</li>
            </ul>
            ...
            <div className="bg-white rounded-full h-[5rem] w-[5rem] justify-center items-center flex absolute left-5 top-5">
                <h1 className='text-center text-md font-bold text-[RGB(0,181,183)]'>Before Tax</h1>
            </div>
        </div>
        
        <div className='flex flex-col p-5 justify-center items-center bg-[RGB(82,105,127)] w-[36rem] h-[20rem] rounded-[2rem] relative'>
            <p className="text-sm text-[RGB(251,99,64)] font-semibold">Understand</p>
            <h2 className="font-bold xs:text-[1rem] sm:text-[1.5rem] md:text-[2.5rem] text-white">Non-Concessional</h2>
        
            <ul>
                <li className='text-[RGB(229,229,229)] text-lg'>1.  Contributions from income you’ve already paid tax on</li>
                <li className='text-[RGB(229,229,229)] text-lg'>2. Not taxed again when deposited into super</li>
            </ul>
            <Info className = {"absolute top-4 right-4 w-8 h-8 flex justify-center items-center"}></Info>
            <div className="bg-white rounded-full h-[5rem] w-[5rem] justify-center items-center flex absolute left-5 top-5">
                <h1 className='text-center text-md font-bold text-[RGB(0,181,183)]'>After <br></br> Tax</h1>
            </div>
