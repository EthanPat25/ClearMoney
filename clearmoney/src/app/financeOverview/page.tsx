    ...
    <div className="w-screen min-h-screen flex flex-col">
      ...
      <div className=" bg-gray-100 p-6 h-[50rem]">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          {/* Card 1 */}
          <motion.div
            className="bg-[RGB(255,255,255)] rounded-2xl p-6 shadow-md w-[24rem] h-[23.5rem] flex flex-col justify-between"
          ...
          >
            ...
            <div className="flex justify-center">
              <Button className="w-[14.5rem] h-10 bg-[RGB(82,105,127)] font-bold">
                See the Difference
              </Button>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex justify-center">
              <Button className="bg-[RGB(82,105,127)] w-[14.5rem] h-10 font-bold">
      ...
      <div className="flex flex-col items-start p-14 w-full">
        <h2 className="font-bold xs:text-[2rem] sm:text-[2.5rem] md:text-[2.5rem]">
