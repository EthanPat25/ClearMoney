    ...
    <div className="w-screen min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-b from-[rgb(3,181,183)] to-[#9bdbdc] p-6 pb-16">
        ...
        <div className="flex justify-center mb-5">
          <div className="flex w-[31rem] justify-center ${justify-between}">
...
*/}
      ...
      <div className=" bg-gray-100 p-6">
        ...
        <div className="flex flex-wrap justify-center gap-5">
          ...
          >
            <div>
              <h2 className="text-[RGB(255,255,255)] font-bold text-center text-[1.1rem]">
            ...
            <div className="flex justify-center">
              <Link prefetch={false} href="/holdings">
                <Button className="w-[14.5rem] h-10 font-bold bg-[RGB(251,99,64)] hover:bg-[rgb(230,85,55)] active:bg-[rgb(200,70,40)]">
          ...
          >
            ...
            <div className="flex justify-center">
              <Link prefetch={false} href="/SuperGap">
                <Button className="w-[14.5rem] h-10 bg-[RGB(251,99,64)] hover:bg-[rgb(230,85,55)] active:bg-[rgb(200,70,40)] font-bold">
                  See the Difference
                </Button>
              </Link>
            </div>
