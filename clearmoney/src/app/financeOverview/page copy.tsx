...
export default function SuperContributions() {
  ...
  return (
    <div className="w-screen p-6 bg-[RGB(3,181,183)] relative">
        ...
        <Superannuation animate={true}></Superannuation>

        </div>

                  <h2 className="text-center text-[RGB(255,255,255)] font-bold xs:text-[2.5rem] sm:text-[3rem] md:text-[3.7rem]">Get a Clearer View of <br></br>Your Super</h2>
        </div>
...
*/}
  ...
  <motion.div key={1} className="relative bg-[RGB(82,105,127)] rounded-3xl p-6 shadow-md w-80 text-white" whileHover={{scale: 1.05}} transition={{type: "spring", stiffness: 200, damping: 10 }}>
            <div className="flex items-center">
            <h2 className=" text-2xl font-[700] text-white">{"Super Scan"}</h2>
            <p className="text-sm text-[RGB(251,99,64)] font-semibold ml-5">(AI-powered)</p>
            </div>
            <p className="text-sm text-white font-[600] ">Upload Your Statements and demystify your Super</p>
              <svg
    xmlns="http://www.w3.org/2000/svg"
    className="w-4 h-4"
    viewBox="0 0 24 24"
...
<h2 className="font-bold text-[1.7rem] text-[RGB(255,255,255)]">Super Gap Calculator</h2>
<div className="flex justify-center">
<Bar></Bar>
</div>

    <p className="text-sm text-[RGB(251,99,64)] font-semibold">Explore your Savings</p>
      <div className="flex justify-center">
      <Button className="w-52 h-10 bg-[RGB(82,105,127)]">Calculate</Button>
    </div>
</div>
...
<div className="w-1/2 flex justify-center items-center">
  ...
  <div className="bg-[RGB(133,211,61)] rounded-xl p-6 shadow-md w-[24rem] h-[23rem] ml-5 mt-10">
    ...
    <div className=" flex flex-col justify-evenly">
      ...
      <h2 className="font-bold text-center text-[1.5rem] text-[RGB(255,255,255)]">See How Super Can Boost Your First Home Deposit</h2>
...
<div className="flex justify-center">
    ...
    <p className="text-sm text-[RGB(255,255,255)] font-semibold mb-5">Super contributions are taxed differently. FHSS Scheme turns this into a first home advantage.</p>
    <div className="flex justify-center">
      <Button className=" w-52 h-10 bg-[RGB(82,105,127)]">Calculate</Button>
    </div>
</div>
...
<h2 className="font-bold text-center text-[1.5rem] text-[RGB(82,83,127)]">See What Your Super Fund Actually Invests In</h2>
<div className="flex justify-center">
<Piee></Piee>
</div>
    <p className="text-bas text-center text-[RGB(251,99,64)] font-semibold mb-5">Discover the companies and sectors your money is funding</p>
    <div className="flex justify-center">
      <Button className="bg-[RGB(82,105,127)] w-52 h-10">Calculate</Button>
    </div>
</div>
...
<div className="w-1/2 flex justify-center items-center">
  ...
  <div className="flex justify-evenly mt-20">
        {[
          { label: "Super Scan", icon: <MoneyBag sizeSp = {50}></MoneyBag>, amount: takeHomePay },

        ].map((item, index) => (
          <motion.div key={index} className="relative bg-[RGB(82,105,127)] rounded-3xl p-6 shadow-md w-80" whileHover={{scale: 1.05}} transition={{type: "spring", stiffness: 200, damping: 10 }}>
            <div className="flex items-center">
  ...
  <h2 className="font-bold xs:text-[1.5rem] sm:text-[2rem] md:text-[2.5rem]">Where Does My Salary Go?</h2>
      ...
      <div className="flex flex-col items-start ml-10">
        <div className="bg-white rounded-xl p-6 shadow-md w-96 text-center">
          ...
          {/* Slider for extra super contributions */}
              ...
              <h2 className="font-bold text-[1.5rem] text-[RGB(82,83,127)] text-center">Super Balance: $21,555</h2>
      ...
      <div className="flex justify-evenly mt-20">
        {[
          { label: "Upload Your Super Statements", icon: <Upload animate = {true}></Upload>, amount: takeHomePay },
          { label: "Enter Your Information", icon: <Upload animate = {true}></Upload>, amount: takeHomePay }
        ].map((item, index) => (
          <motion.div key={index} className="relative bg-[RGB(82,105,127)] rounded-3xl p-6 shadow-md text-center w-1/5" whileHover={{scale: 1.05}} transition={{type: "spring", stiffness: 200, damping: 10 }}>
            <h2 className="font-semibold text-white">{item.label}</h2>
            <div className="flex justify-center mb-4">{item.icon}</div>
      ...
      <div className="flex flex-col items-start ml-10 mt-10">
        <div className="bg-white rounded-xl p-6 shadow-md w-96 text-center">
          ...
          {/* Slider for extra super contributions */}
              ...
              <h2 className="font-bold text-[1.5rem] text-[RGB(82,83,127)] text-center">Savings: $10,555</h2>
      ...
      <div className="flex flex-col items-start ml-10 mt-10">
        <div className="bg-white rounded-xl p-6 shadow-md w-96 text-center">
          ...
          {/* Slider for extra super contributions */}
              ...
              <h2 className="font-bold text-[1.5rem] text-[RGB(82,83,127)] text-center">Investments: $5,555</h2>
      ...
      <div className="flex flex-col items-start ml-10 mt-10">
        <div className="bg-white rounded-xl p-6 shadow-md w-96 text-center">
          ...
          {/* Slider for extra super contributions */}
              ...
              <h2 className="font-bold text-[1.5rem] text-[RGB(82,83,127)] text-center">Debt: $34,555</h2>
      ...
      <div className="flex justify-evenly mt-20">
        {[
          { label: "Higher Education", icon: <MoneyBag sizeSp = {150}></MoneyBag>, amount: takeHomePay },
          { label: "Car", icon: <Taxes animate = {true}></Taxes>, amount: salary * marginalTaxRate },
          { label: "Personal", icon: <Medicare animate = {true}></Medicare>, amount: 2000 },
          { label: "Paid into Super", icon: <Superannuation animate = {true}></Superannuation>, amount: 7000 }
        ].map((item, index) => (
          <motion.div key={index} className="relative bg-[RGB(82,105,127)] rounded-3xl p-6 shadow-md text-center w-1/5" whileHover={{scale: 1.05}} transition={{type: "spring", stiffness: 200, damping: 10 }}>
                        <Info className = {"absolute top-4 right-4 w-8 h-8 flex justify-center items-center"}></Info>
      ...
      <div className="flex flex-col items-start ml-10 mt-10">
        <div className="bg-white rounded-xl p-6 shadow-md w-96 text-center">
          ...
          {/* Slider for extra super contributions */}
              ...
              <h2 className="font-bold text-[1.5rem] text-[RGB(82,83,127)] text-center">Net Worth: $34,555</h2>
