...
const SideBySide = () => {
  return (
    <div className="flex w-full justify-evenly">
      <motion.div
        className="bg-white rounded-3xl shadow-md w-[45%] text-center mt-5 h-[27rem]"
      ...
      >
        ...
        <div className="p-6 pt-0">
          <div className="mt-4 flex justify-between">
            ...
            <h2 className="text-left">+ $35,000</h2>
          </div>
          <div className="mt-4 mb-4 flex justify-between">
            <h2 className="text-left">Tax Refunded</h2>
            <h2 className="text-left">+ $11,000</h2>
          </div>
          <div className="mt-4 mb-4 flex justify-between">
            <h2 className="text-left">Interest Earnt</h2>
            <h2 className="text-left">+ $4,000</h2>
          </div>
          <div className="mt-4 mb-4 flex justify-between">
            <div className="flex justify-center items-center">
              <h2 className="text-left font-bold">Total Eligible</h2>
              <Info
                className={"ml-1 w-4 h-4 flex justify-center items-center"}
              ></Info>
            </div>
          ...
          <div className="mt-4 mb-4 flex justify-between">
            <h2 className="text-left">Tax Offset</h2>
            <h2 className="text-left">+ $10,000</h2>
          </div>
          <div className="mt-4 mb-4 flex justify-between">
            <div className="flex justify-center items-center">
              <h2 className="text-left font-bold">Total Tax</h2>
              <Info
                className={"ml-1 w-4 h-4 flex justify-center items-center"}
              ></Info>
            </div>
            <h2 className="text-left font-bold">$0</h2>
          </div>
          <div className="mt-4 mb-4 flex justify-between">
      ...
      >
        ...
        <div className="p-6 pt-0">
          ...
          <div className="mt-4 mb-4 flex justify-between">
            <h2 className="text-left font-bold">Total Eligible</h2>
            <h2 className="text-left font-bold">$39,000</h2>
          </div>
          <hr className="w-full border-[RGB(246,246,249)]"></hr>
          <div className="mt-4 flex justify-between">
            <h2 className="text-left">Widthdrawal Tax</h2>
