...
const UnderStand = () => {
  return (
    <div className=" bg-gray-100 h-[37%] rounded-[5rem]">
      ...
      <div className=" rounded-[6rem] mt-16 w-full flex bg-[RGB(82,105,127)] h-[25rem] relative">
        <div className="w-[56rem] flex justify-center flex-col items-center">
          <h1 className="text-3xl font-bold text-[rgb(251,99,64)]">
            Meet Parent A and Parent B
          </h1>

          <p className="mt-3 text-lg text-center leading-relaxed text-[rgb(229,229,229)] w-[35rem]">
            After their first child, Parent B works{" "}
            <strong>part-time for 10 years</strong>. Parent B ends up{" "}
            <strong>$80,000 behind</strong>—that’s the{" "}
        ...
        <div className="rounded-full bg-white absolute top-8 left-8 h-20 w-20 flex justify-center items-center">
