      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="space-y-6">
            <h3 className="text-2xl font-semibold">ClearMoney</h3>
            <p className="text-slate-400 leading-relaxed">
              Making superannuation engaging and accessible to young Australians
              through visual tools and clear breakdowns.
            </p>
            <div className="flex space-x-4">
              <div className="w-10 h-10 bg-slate-800 rounded-xl flex items-center justify-center hover:bg-slate-700 cursor-pointer transition-colors">
                <svg
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="text-slate-400">Educational Tools</div>
              <div className="text-slate-400">Visual Learning</div>
              <div className="text-slate-400">Super Made Simple</div>
              <div className="text-slate-400">Young Australians</div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="text-sm text-slate-400">
              ClearMoney 2025 - Built for educational purposes.
            </div>
          </div>
